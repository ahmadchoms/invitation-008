...
export function CoupleSection() {
  return (
    <section className="py-24 px-6 md:py-32 bg-muted/30 relative overflow-hidden text-center">
      ...
      >
        <h2 className="text-sm tracking-widest uppercase text-accent font-semibold mb-4">Mempelai</h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
          ...
          >
            <div className="w-48 h-48 md:w-60 md:h-60 rounded-full border-4 border-white shadow-xl overflow-hidden mb-6 relative group">
              {/* Image Placeholder */}
              <div className="absolute inset-0 bg-gradient-to-tr from-accent/20 to-secondary/30" />
              <img 
          ...
          >
            <span className="font-heading text-6xl text-accent/80 font-light">&amp;</span>
          </motion.div>
          ...
          >
            <div className="w-48 h-48 md:w-60 md:h-60 rounded-full border-4 border-white shadow-xl overflow-hidden mb-6 relative group">
              {/* Image Placeholder */}
              <div className="absolute inset-0 bg-gradient-to-bl from-accent/20 to-secondary/30" />
              <img 
