  ...
  return (
    <section className="py-24 px-6 md:py-32 bg-muted/30 relative overflow-hidden text-center">
      ...
      >
        ...
        <p className="text-secondary max-w-2xl mx-auto mb-16 text-sm md:text-base leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
          <motion.div
            ...
            className="flex flex-col items-center flex-1 max-w-75"
          >
          ...
          <motion.div
            ...
            className="shrink-0"
          >
            <span className="font-script text-7xl text-accent/80 font-light drop-shadow-sm">
              &amp;
            </span>
          </motion.div>
